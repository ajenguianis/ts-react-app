            ...
            <div id="header-carousel" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img className="w-100" src="/assets/images/carousel-bg-1.jpg" alt="Car repair service" />
                            ...
                            <div className="container">
                                <div className="row align-items-center justify-content-center justify-content-lg-start">
                                    ...
                                    <div className="col-lg-5 d-none d-lg-flex animated zoomIn">
                                        <img className="img-fluid" src="/assets/images/carousel-1.png" alt="Car repair illustration" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="carousel-item">
                        <img className="w-100" src="/assets/images/carousel-bg-2.jpg" alt="Car wash service" />
                        <div className="carousel-caption d-flex align-items-center">
                            <div className="container">
                                <div className="row align-items-center justify-content-center justify-content-lg-start">
                                    <div className="col-10 col-lg-7 text-center text-lg-start">
                                    ...
                                    <div className="col-lg-5 d-none d-lg-flex animated zoomIn">
                                        <img className="img-fluid" src="/assets/images/carousel-2.png" alt="Car wash illustration" />
                                    </div>
                                </div>
                            </div>
                        </div>
